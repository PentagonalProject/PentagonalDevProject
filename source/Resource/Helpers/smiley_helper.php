		...
		if ($do_setup === true) {
			...
			function insert_smiley(smiley, field_id)
			{
				...
				if ('selectionStart' in el) {
					var newStart = el.selectionStart + smiley.length,
	...
	function get_clickable_smileys($image_url, $alias = '')
	{
		...
		foreach ($smileys as $key => $val) {
			...
			$link[] = '<a href="javascript:void(0);" onclick="insert_smiley(\''
                ...
                . $alias
                . '\')"><img src="'
                . $image_url.$smileys[$key][0]
                .'" alt="'.$smileys[$key][3].'" class="smiley_icons" style="width: '
                . $smileys[$key][1].'; height: '.$smileys[$key][2].'; border: 0;" /></a>';
...
if ( ! function_exists('_get_smiley_array'))
{
	...
	{
		return (array) Processor::config('smiley');
	}
}
