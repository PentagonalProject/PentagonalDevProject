...
class CI_Pagination
{
    ...
    public function __construct($params = array())
    {
        ...
        $this->first_link = $this->CI->lang->line('&lsaquo; First');
        $this->next_link = $this->CI->lang->line('&gt;');
        $this->prev_link = $this->CI->lang->line('&lt;');
        $this->last_link = $this->CI->lang->line('Last &rsaquo;');
