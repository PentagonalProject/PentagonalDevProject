...
abstract class CI_DB_driver
{
    ...
    public function initialize()
    {
        ...
        if (! $this->conn_id) {
            ...
            if (! $this->conn_id) {
                ...
                if ($this->db_debug) {
                    $this->display_error('Unable to connect to your database server using the provided settings.');
                }
    ...
    public function db_set_charset($charset)
    {
        if (method_exists($this, '_db_set_charset') && ! $this->_db_set_charset($charset)) {
            ...
            if ($this->db_debug) {
                $this->display_error('Unable to set client connection character set: %s', $charset);
            }
    ...
    public function version()
    {
        ...
        if (false === ($sql = $this->_version())) {
            return ($this->db_debug) ? $this->display_error('This feature is not available for the database you are using.') : false;
        }
    ...
    public function query($sql, $binds = false, $return_object = null)
    {
        if ($sql === '') {
            ...
            return ($this->db_debug) ? $this->display_error('The query you submitted is not valid.') : false;
    ...
    public function display_error($error = '', $swap = '', $native = false)
    {
        ...
        $heading = $LANG->line('A Database Error Occurred');
